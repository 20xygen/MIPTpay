...
sber_debit_model = src.Adapter().create_plan(sber_debit, sber_model, "Sberbank debit plan")
...
sber_deposit_model = src.Adapter().create_plan(sber_deposit, sber_model, "Sberbank deposit plan")
...
sber_credit_model = src.Adapter().create_plan(sber_credit, sber_model, "Sberbank credit plan")
...
denis_sber_model = src.Adapter().create_client(denis_sber, sber_model, denis_model)
...
misha_sber_model = src.Adapter().create_client(misha_sber, sber_model, misha_model)
...
artem_sber_model = src.Adapter().create_client(artem_sber, sber_model, artem_model)
...
denis_tink_model = src.Adapter().create_client(denis_tink, tink_model, denis_model)
...
misha_tink_model = src.Adapter().create_client(misha_tink, tink_model, misha_model)
...
denis_sber_deposit_model = src.Adapter().create_account(denis_sber_deposit, sber_model, denis_sber_model, sber_deposit_model)
...
denis_sber_credit_model = src.Adapter().create_account(denis_sber_credit, sber_model, denis_sber_model, sber_credit_model)
...
denis_tink_debit_model = src.Adapter().create_account(denis_tink_debit, tink_model, denis_tink_model, tink_debit_model)
...
denis_tink_deposit_model = src.Adapter().create_account(denis_tink_deposit, tink_model, denis_tink_model, tink_deposit_model)
...
denis_tink_credit_model = src.Adapter().create_account(denis_tink_credit, tink_model, denis_tink_model, tink_credit_model)
...
misha_sber_debit_model = src.Adapter().create_account(misha_sber_debit, sber_model, misha_sber_model, sber_debit_model)
...
misha_sber_deposit_model = src.Adapter().create_account(misha_sber_deposit, sber_model, misha_sber_model, sber_deposit_model)
...
misha_tink_debit_model = src.Adapter().create_account(misha_tink_debit, tink_model, misha_tink_model, tink_debit_model)
...
misha_tink_credit_model = src.Adapter().create_account(misha_tink_credit, tink_model, misha_tink_model, tink_credit_model)
...
artem_sber_debit_model = src.Adapter().create_account(artem_sber_debit, sber_model, artem_sber_model, sber_debit_model)
...
artem_sber_deposit_model = src.Adapter().create_account(artem_sber_deposit, sber_model, artem_sber_model, sber_deposit_model)
...
artem_sber_credit_model = src.Adapter().create_account(artem_sber_credit, sber_model, artem_sber_model, sber_credit_model)
